...
SYMPHONY.remote.hello().then(function(data) {
    ...
    SYMPHONY.application.connect("twitter-stream", ["modules", "applications-nav", "ui", "share"], ["twitter-stream:app"]).then(function(response) {
        ...
        hideButton.addEventListener("click", function() {
            ...
            modulesService.hide("twitter-stream");
        });
        ...
        setTitleButton.addEventListener("click", function() {
            ...
            modulesService.setTitle("twitter-stream", "New Module Title");
        });
        ...
        removeLeftNavItemButton.addEventListener("click", function() {
            ...
            navService.remove('twitter-stream-nav-remove');
        });

        // LEFT NAV: Rename the left navigation item ("twitter-stream-nav") when the "Rename Left Nav Item" button is clicked
        ...
        renameLeftNavItemButton.addEventListener("click", function() {
            ...
            navService.rename('twitter-stream-nav', 'New Left Nav Title');
        });
        ...
        unregisterRoomExtensionButton.addEventListener("click", function() {
            ...
            // This will remove only the extension of a given ID ('twitter-stream-room') for a given class ('room')
            uiService.unregisterExtension('room', 'twitter-stream-room');
        });
        ...
        twitterAppService.implement({
            // If the menu item is selected, display the About text
            menuSelect: function(itemId) {
                if (itemId == "twitter-stream-menu-item") {
                    document.getElementById("about-twitter-stream-world-app").className = "";
                }
            }
        });
